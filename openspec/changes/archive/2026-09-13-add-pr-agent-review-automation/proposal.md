...
- Configure OpenCode Go's Chat Completions-compatible MiMo-V2.5 model and provide a stable per-PR session header.
...
- Model routing: `openai/mimo-v2.5` via `https://opencode.ai/zen/go/v1`, with a stable per-PR `x-opencode-session` header.
