...
- [x] 2.1 Update `docs/development/ci.md` with both secret setups, notification contents, event coverage, missing-secret behavior, and rollback/failure isolation.
