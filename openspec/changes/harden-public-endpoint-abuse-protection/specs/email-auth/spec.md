...
#### Scenario: Public issuance is bounded

- **WHEN** a client repeatedly requests codes for one or many email addresses
- **THEN** shared client and resource limits eventually reject requests without returning a code
