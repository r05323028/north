...
The checked-in `main` history ends at 0017. New migrations must be strictly after
...
state; `0017_runtime_event_retention.sql` adds activity expiry; and
`0018_public_endpoint_abuse_protection.sql` adds the legacy-compatible setup
CIDR quota key and partial index. Never insert a new migration into the
0001–0018 history.
